							...
							<div class="card-body card-block">
								<form action="adddetail" method="post"
									...
									<input type="hidden" class="form-control"
										value="<%=request.getAttribute("idHoaDon")%>" name="idHoaDon">
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="form-control-label">Giá bán</label> <input
													type="number" class="form-control" readonly="readonly" id="gia">
											</div>
											<div class="form-actions form-group">
												<button type="submit" class="btn btn-success">Lưu
													lại</button>
												<a class="btn btn-danger" href="viewdetail?idHoaDon=<%=request.getAttribute("idHoaDon")%>">Hủy bỏ</a>
											</div>
										</div>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="form-control-label">Khuyến mãi</label> <input
													type="number" class="form-control" readonly="readonly" id="khuyenmai">
											</div>
