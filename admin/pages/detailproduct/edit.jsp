...
<body>
	<%
		DetailProducts detail = (DetailProducts) request.getAttribute("detail");
	%>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div>
													...
													%>
													<img
														src="../../../assets/img/shop/DetailProduct/<%=detail.getAnhChiTiet()%>"
											...
											<div class="form-actions form-group">
												...
												<a class="btn btn-danger"
													href="list?id=<%=detail.getId_sanPham()%>">Hủy bỏ</a>
											</div>
										</div>
									</div>
								</form>
