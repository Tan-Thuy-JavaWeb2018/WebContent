					...
					<div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="edit" method="post" enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                <input type="hidden" id="" class="form-control" value="${ category.getId() }" name="id">
                                    <div class="row">
                                        ...
                                        <input type="text" placeholder="Nhập tên loại sản phẩm" class="form-control" value="${ category.getTenloai() }" name="tenloai">
                                    </div>
