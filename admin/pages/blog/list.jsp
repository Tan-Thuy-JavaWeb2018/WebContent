						...
						<div class="card">
							...
							<div class="card-body">
								<table id="bootstrap-data-table"
									...
									<tbody>
										<%
											ArrayList<Blogs> list = (ArrayList<Blogs>) request.getAttribute("list");
											for (Blogs l : list) {
										%>
										<tr>
											<td><%=l.getId()%></td>
											...
											<td style="min-width: 100px;">
												<%
													if (l.getHinhanh() != "") {
												%> <a
												href="../../../assets/img/blog/<%=l.getHinhanh()%>">
													<img alt=""
													src="../../../assets/img/blog/<%=l.getHinhanh()%>"
													style="width: 100%">
											</a> <%
 	}
 %>
